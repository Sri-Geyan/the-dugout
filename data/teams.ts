...
export const IPL_TEAMS: IPLTeam[] = [
    ...
    { id: 'pbks', name: 'Punjab Kings', shortName: 'PBKS', color: '#ED1B24', colorDark: '#C51019', colorLight: '#EF5350', emoji: '🦁', logo: '/images/teams/pbks.png', city: 'Punjab' },
    { id: 'rr', name: 'Rajasthan Royals', shortName: 'RR', color: '#EA1A85', colorDark: '#C0106B', colorLight: '#F06292', emoji: '💎', logo: '/images/teams/rr.png', city: 'Rajasthan' },
    { id: 'lsg', name: 'Lucknow Super Giants', shortName: 'LSG', color: '#01AEEF', colorDark: '#0091C8', colorLight: '#4FC3F7', emoji: '🦏', logo: '/images/teams/lsg.png', city: 'Lucknow' },
    { id: 'gt', name: 'Gujarat Titans', shortName: 'GT', color: '#1C1C2B', colorDark: '#101018', colorLight: '#39395C', emoji: '⚡', logo: '/images/teams/gt.png', city: 'Gujarat' },
];
