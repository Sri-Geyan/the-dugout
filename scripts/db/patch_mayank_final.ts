...
async function main() {
    ...
    const missingPlayers = sqliteDb.prepare("SELECT * FROM players WHERE name IN ('Mayank Yadav', 'Rasikh Dar', 'Yudhvir Charak')").all() as any[];
    ...
    for (const player of missingPlayers) {
        ...
        const dbName = ALIAS_MAP[player.name];
